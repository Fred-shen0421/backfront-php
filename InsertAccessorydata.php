<?php
    ...
    if($_POST["SORT"] == ''){
        ...
        //取得上傳的檔案資訊=======================================
        $one = $_POST["SORT"];    //檔案名稱含副檔名
        $two = $_POST["PRODUCTNAME"];
        $three = $_POST["PRODUCTPRICE"];
        $four = $_POST["PRODUCTINFO"];
        ...
        $sql = "INSERT INTO ACCESSORIES(SORT, PRODUCTNAME, PRODUCTPRICE, PRODUCTINFO, PRODUCTIMG) VALUES ( ? , ? , ? , ? , ? )";
        ...
        $statement->bindValue(5 , $realPath);
        $statement->execute();
    }
?>